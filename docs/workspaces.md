...
| 6 — Publication and deployment | In progress | Homepage, HTTP/WebSocket documentation, license selection and public repository preparation, then EC2/DNS/TLS for the four product addresses. |
